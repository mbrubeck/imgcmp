...
pub trait ImageView<I: GenericImageView> {
    fn view(&self, x: u32, y: u32, width: u32, height: u32) -> Box<Self>;
...
where
    I::InnerImageView: GenericImageView<InnerImageView = I>,
{
    fn bounds(&self) -> (u32, u32, u32, u32) {
        self.bounds()
    }

    fn view(&self, x: u32, y: u32, w: u32, h: u32) -> Box<Self> {
        Box::new(self.view(x, y, w, h))
    }
    ...
    I: Deref<Target = &'i I>,
{
    ...
    fn view(&self, x: u32, y: u32, w: u32, h: u32) -> Box<Self> {
        Box::new(<Self as GenericImageView>::view(self, x, y, w, h))
    }
